...
class UserAdmin(admin.ModelAdmin):
    list_display = ('id', 'get_fulname', 'email', 'company', 'is_active', 'is_admin', 'is_superuser')
    list_display_links = ('id', 'get_fulname', 'email')
    list_filter = ('company', 'is_active', 'is_admin',  'applicant__location', 'is_superuser')
    search_fields = ('email', 'first_name', 'last_name')
    readonly_fields = ('id', 'last_login', 'first_name', 'last_name', 'password', 'email', 'company')
    ...
    def get_fulname(self, obj):
        return f'{obj.first_name} {obj.last_name}'
    
    get_fulname.short_description = 'ФИО'
...
class ApplicantAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('get_image','birthday', 'location', 'citizenship', 'education',
                     'specialization', 'skills', 'languages')
