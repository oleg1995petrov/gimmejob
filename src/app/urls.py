...
urlpatterns = [
    ...
    path('experience/edit/', views.EditExperienceView.as_view(), name='edit_experience'),
    path('experience/delete/id<int:exp_id>/', views.DeleteExperienceView.as_view(), name='delete_experience'),
    # EMPLOYER ACTIONS
    ...
    # path('vacancy/', views.View.as_view(), name='vacancy_search'),
   
   
    # PASSWORD CHANGE/RESET
    path('password_change/', views.PasswordChangeView.as_view(), name='password_change'),
    path('password_reset/', views.PasswordResetView.as_view(), name='password_reset'),
    path('password_reset/<uidb64>/<token>/', views.PasswordResetCompletedView.as_view(), name='password_reset_completed'),
